...
int hyperamp_linux_init(uint64_t phys_addr, int is_creator)
{
    ...
    // 0xDE000000: RX Queue (4KB) - seL4 写, Linux 读 (seL4 发送请求给 Linux)
    // 0xDE001000: TX Queue (4KB) - Linux 写, seL4 读 (Linux 发送响应给 seL4)
    // 0xDE002000: Data Region (4MB) - 共享数据区
    // 
    // Linux 的 RX Queue = seL4 的 TX Queue (物理地址 0xDE000000)
